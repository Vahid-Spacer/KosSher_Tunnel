...
download_and_extract_rathole() {
    ...
    if [[ "$ARCH" == "x86_64" ]]; then
    	DOWNLOAD_URL='https://github.com/Vahid-Spacer/kossher_tunnel/raw/main/core/rathole.zip'
    fi
...
EOF
    ...
    echo -e "Github: ${YELLOW}github.com/Vahid-Spacer/KosSher_Tunnel${GREEN}"
...
SCRIPT_URL="https://github.com/Vahid-Spacer/kossher_tunnel/raw/main/rathole_v2.sh"
...
install_modified_core(){
	echo
	DOWNLOAD_URL='https://github.com/Vahid-Spacer/kossher_tunnel/raw/main/core/rathole_modified.zip'
