...
EOF
    ...
    echo -e "Developer: ${YELLOW}Vahid-Spacer${GREEN}"
    echo -e "Github: ${YELLOW}github.com/Vahid-Spacer/Rathole-Tunnel${GREEN}"
...
SCRIPT_URL="https://github.com/Vahid-Spacer/KosSher_Tunnel/raw/main/rathole.sh"
